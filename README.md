...
I'm a Technology Specialist who lives at the intersection of **AI/ML and full-stack engineering**. I build and ship machine learning solutions — from model experimentation to production-grade APIs — and back them with the cloud infrastructure and DevOps practices (Kubernetes, auto-scaling, load balancing) needed to run them reliably at scale.

I also bring hands-on experience in client communication, architectural design decisions, real-time complex web projects, and game services development.
...
### 🔧 Version Control, Tools & Integrations
...
Also experienced with Microsoft Project, Teamwork, Smartsheet, Airtable, Eureka/Zuul service discovery, token-based/passport authentication, and automation testing.
